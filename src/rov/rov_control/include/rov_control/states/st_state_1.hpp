...
// ORTHOGONALS
using rov_control::OrTimer;  // This is an example variable - feel free to delete it.
...
using rov_control::OrTimer;

// STATE DECLARATION
struct State1 : smacc2::SmaccState<State1, RovControl>
{
